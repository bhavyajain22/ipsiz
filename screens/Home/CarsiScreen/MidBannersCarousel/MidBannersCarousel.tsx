...
const MidBannersCarousel: React.FC = () => {
  ...
  useEffect(() => {
    getCarsiMidBanners().then(({data: {data}}) => setBanners(data));
...
export default memo(MidBannersCarousel);
