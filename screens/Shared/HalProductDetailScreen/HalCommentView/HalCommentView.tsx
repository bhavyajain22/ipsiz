...
import {styles} from './HalCommentView.styles';
      ...
      {comments && comments.length ? (
        <>
          <View style={styles.headerContainer}>
            <H2Typo text="En Son Yorum" textStyle={{color: COLORS.mainBlue}} />
