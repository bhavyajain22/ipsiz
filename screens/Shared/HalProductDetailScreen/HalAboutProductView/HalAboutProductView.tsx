...
import {styles} from './HalAboutProductView.styles';

const HalAboutProductView: React.FC<{
  handlePress: (focusedTab: 0 | 1 | 2 | 3) => void;
}> = ({handlePress}) => {
  return (
    <>
      <TouchableOpacity
      ...
      <TouchableOpacity
        ...
        style={styles.singleItem}>
        <H2Typo text="Mütabakat Şartları" textStyle={styles.textStyle} />
        <FontAwesome5 name="chevron-right" color="#606060" size={18} />
      </TouchableOpacity>
    </>
  );
...
export default HalAboutProductView;
